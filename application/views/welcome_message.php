    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Masak Yuk</a>
            </div>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Memasak Jadi Lebih Mudah!</h1>
                <hr>
                <p>Takut kesulitan dalam memasak? Jangan Khawatir! Masak Yuk adalah Panduan Memasak yang kaya akan fitur-fitur canggih yang pastinya akan membantumu memasak berbagai macam masakan dengan mudah</p>
                <a href="https://play.google.com/store/apps/details?id=com.insiteprojectid.masakyuk" class="btn btn-primary btn-xl page-scroll">Download Sekarang</a>
            </div>
        </div>
    </header>
